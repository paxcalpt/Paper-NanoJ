...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\linewidth]{Figures/SFigure_PumpOnScope}
    \caption{\textbf{Assembled NanoJ-Fluidics system on a microscope.} a) View of assembled pump array with syringes loaded on top of a Nikon N-STORM microscope, an individual syringe pump unit sits inside the incubator and is kept at 37\degree C in the microscope incubator, allowing the use of reagents equilibrated at the same temperature as the sample, such as fixatives. b) Top view of the syringe pump array. c) Zoom into the individual syringe pump unit inside incubator.}
    \label{supFig:PumpOnScope}
\end{figure}
%TC:endignore
